...
export default function TemplatesPage() {
  ...
  // Fetch from Supabase and seed missing defaults
  useEffect(() => {
      ...
      try {
        ...
        const defaultTemplates = [
          ...
          },
          {
            ...
            type: 'EMAIL',
            name: 'Schedule Call Back',
            body: '<p>Hi [Name],</p><p>As per our conversation, we will call you back later. Please let us know what date and time works best for you!</p><p>Best regards,<br>Convenio Mart Franchise Team</p>',
            attachment_url: ''
          },
          {
          ...
          },
          {
            ...
            type: 'WHATSAPP',
            name: 'Schedule Call Back',
            body: 'Hi [Name], as per our conversation, we will call you back later. Please let us know what date and time works best for you!',
            attachment_url: ''
          },
          {
        ...
        // Seed missing defaults AND update existing system templates whose body changed
        for (const dt of defaultTemplates) {
          ...
          } else if (existing.body !== dt.body) {
            // Update if body changed (fixes corrupted emojis already in DB)
            await saveTemplate({ ...dt, id: existing.id });
          }
        }
  ...
  const handleSaveTemplate = async (e) => {
    ...
    try {
      ...
      const refetched = await getTemplates();
