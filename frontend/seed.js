...
const templates = [
  ...
  { is_system: true, status_trigger: 'CALL_LATER', type: 'EMAIL', name: 'Schedule Call Back', body: '<p>Hi [Name],</p><p>As per our conversation, we will call you back later. Please let us know what date and time works best for you!</p><p>Best regards,<br>Convenio Mart Franchise Team</p>', attachment_url: '' },
  ...
  { is_system: true, status_trigger: 'CALL_LATER', type: 'WHATSAPP', name: 'Schedule Call Back', body: 'Hi [Name], as per our conversation, we will call you back later. Please let us know what date and time works best for you! 🕒', attachment_url: '' },
